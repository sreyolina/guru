    ...
    def create_data_source_connection(self, datasource_name: str, container_name: str) -> SearchIndexerDataSourceConnection:
        ...
        try:
            ...
            if use_managed_identity:
                ...
                connection_string = f"ResourceId={storage_resource_id};Identity={self.managed_identity_resource_id};"
                ...
                logger.info(f"Creating data source with identity: {data_source.connection_string}")
